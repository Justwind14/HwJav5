...
public class Main {
    public static void main(String[] args) {
        ...
        fillCollection(familyCollection);  // вызов первыйо задачи

        listWorker(workerCollection,list);   //вызов второй
    }

    static void fillCollection(Map<Integer, String> getCollection) {
        ...
        static void listWorker(TreeMap < String, Integer > workerColl, String getList){
        /*        Пусть дан список сотрудников: Иван Иванов, Светлана Петрова, Кристина Белова, Анна Мусина, Анна Крутова,
                Иван Юрин, Петр Лыков, Павел Чернов, Петр Чернышов, Мария Федорова, Марина Светлова, Мария Савина, Мария Рыкова,
                        Марина Лугова, Анна Владимирова, Иван Мечников, Петр Петин, Иван Ежов. Написать программу,
                         которая найдет и выведет повторяющиеся имена с количеством повторений.
                          Отсортировать по убыванию популярности. Использовать TreeMap.
        */
